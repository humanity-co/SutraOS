            ...
            <div className="lg:col-span-3 space-y-6">
              ...
              <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-200/60">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div onClick={() => window.location.href='/finance-hr'} className="bg-slate-50 hover:bg-blue-50 border border-slate-100 hover:border-blue-100 p-4 rounded-2xl flex flex-col items-center justify-center text-center cursor-pointer transition-colors group">
                     <Calendar size={24} className="text-slate-400 group-hover:text-blue-500 mb-2 transition-colors" />
                     <span className="text-xs font-bold text-slate-600 group-hover:text-blue-700">Leaves</span>
                  </div>
                  <div onClick={() => window.location.href='/finance-hr'} className="bg-slate-50 hover:bg-emerald-50 border border-slate-100 hover:border-emerald-100 p-4 rounded-2xl flex flex-col items-center justify-center text-center cursor-pointer transition-colors group">
                     <CheckCircle2 size={24} className="text-slate-400 group-hover:text-emerald-500 mb-2 transition-colors" />
                     <span className="text-xs font-bold text-slate-600 group-hover:text-emerald-700">Approvals</span>
                  </div>
